    ...
    <div className="min-h-screen font-mono flex flex-col">
      ...
      <div className="flex-1 grid md:grid-cols-2 gap-0">
        ...
        <div className="p-6 md:p-12 lg:p-16 flex flex-col justify-center -mt-20">
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-black">Create your account today!</p>
        </div>
            ...
            <form className="space-y-4 md:space-y-8">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="save-details" className="ml-2 block text-sm text-gray-900">
                    Save login details
                  </label>
                </div>
                <Link href='/dashboard'>
